...
\begin{frame}{Primitive 1 --- Distributed Locking with Fencing Tokens}
\begin{itemize}
...
\begin{frame}{Primitive 2 --- Atomic Decrement via Redis Lua}
...
\begin{frame}{Primitive 3 --- OCC with Versioned Cache Entries}
\begin{itemize}
