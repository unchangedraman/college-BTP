...
\begin{titlepage}
    \centering
    \vspace*{1cm}
    {\LARGE \textbf{Reducing Cross-Node Network Calls in Distributed Payment Systems via Thread-Level and Server-Local Caching}}\\[0.4cm]
    {\large \textit{with Concurrency-Safe Resolution of Single-Resource Contention}}\\[1.5cm]
    {\large B.Tech Project Report --- Major Evaluation}\\[2cm]
    ...
    \vfill
    {\large ABV-IIITM Gwalior}\\[0.2cm]
    {\normalsize Atal Bihari Vajpayee Indian Institute of Information Technology and Management}\\[0.5cm]
    {\normalsize 2026}
\end{titlepage}
...
\section{Decision Matrix and Hybrid Architecture}
