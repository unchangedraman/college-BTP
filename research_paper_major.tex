...
\section[Tail Latency]{Tail Latency and Distributed Caching}
...
\section[Multi-Tier Caches]{In-Process and Multi-Tier Caches}
...
\section[Concurrency Control]{Concurrency Control and Distributed Locking}
...
\section[Atomic Operations]{Atomic Operations and Lua Scripting}
...
\section[CRDT Counters]{Eventually-Consistent Counters and CRDTs}
...
\section[Single-Flight \& Stampede]{Single-Flight and Cache Stampede Mitigation}
...
\section[Baseline Performance]{Baseline Performance Characteristics}
...
\section[Tier 1: Thread-Level Cache]{Tier 1: Thread-Level Cache (Request-Scoped)}
...
\section[Tier 2: Server-Local Cache]{Tier 2: Server-Local Cache (Node-Scoped)}
...
\section[Technique 5: Single-Flight]{Technique 5: Single-Flight Request Coalescing}
...
\section[Server-Local Cache]{Server-Local Cache (TVar + LRU + TTL)}
...
\section[Integrated Read Path]{Integrated Read Path with Single-Flight}
...
\section[Why 4\% Matters at Scale]{Why 4\% Network Reduction Matters at Scale}
